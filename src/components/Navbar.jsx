...
function Navbar() {
  ...
  return (
    <div className={`flex fixed z-10 items-center justify-between p-16 h-24 w-screen transition-all duration-300 ${scrolled ? 'bg-white text-black' : 'bg-transparent text-white'}`}>
      <div id="list" className='gap-10 flex text-20'>
        <a href="">Home</a>
        <a href="">Shop</a>
        <a href="">Pages</a>
        <a href="">Blog</a>
